...
output<-readRDS("./output_REAL_ABCSIR_pert_GlobCov_fixed_poissonMu_poissonObs_GLMx0_60000_10brks_regbinspaceFALSE_sampleDTN_autoshift")[[1]]
initSIR$output<-output
